...
func (x *GetContactsRequest) GetUserPhone() string {
	if x != nil {
		return x.UserPhone
	}
	return ""
...
func (x *Contact) GetUserPhone() string {
	if x != nil {
		return x.UserPhone
	}
	return ""
...
type BlockUserRequest struct {
	state          protoimpl.MessageState `protogen:"open.v1"`
	UserPhone      string                 `protobuf:"bytes,1,opt,name=user_phone,json=userPhone,proto3" json:"user_phone,omitempty"`
	BlockUserPhone string                 `protobuf:"bytes,2,opt,name=block_user_phone,json=blockUserPhone,proto3" json:"block_user_phone,omitempty"`
	unknownFields  protoimpl.UnknownFields
	sizeCache      protoimpl.SizeCache
}
...
func (x *BlockUserRequest) GetUserPhone() string {
	if x != nil {
		return x.UserPhone
	}
	return ""
...
func (x *BlockUserRequest) GetBlockUserPhone() string {
	if x != nil {
		return x.BlockUserPhone
	}
	return ""
}
...
const file_pkg_proto_user_proto_rawDesc = "" +
	"\n" +
	"\x14pkg/proto/user.proto\x12\x04user\x1a\x1fgoogle/protobuf/timestamp.proto\"\xa2\x01\n" +
	"\x04User\x12\x1d\n" +
	"\n" +
	...
	"\n" +
	"user_phone\x18\x01 \x01(\tR\tuserPhone\x12(\n" +
	"\x10block_user_phone\x18\x02 \x01(\tR\x0eblockUserPhone\"-\n" +
